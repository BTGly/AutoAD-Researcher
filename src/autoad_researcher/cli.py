...
def build_parser() -> argparse.ArgumentParser:
    ...
    ra_parser = subparsers.add_parser(
        "results-analysis",
        help="Run Stage 3.9 results analysis (metrics comparison, conclusions, report)",
    )
    ra_parser.add_argument("--run-id", required=True, help="Run identifier")
