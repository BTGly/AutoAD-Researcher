...
class ExperimentAttemptStore:
    ...
    def _identity(attempt: ExperimentAttempt) -> dict[str, object]:
        return {
            ...
            "checkpoint_watch_path": attempt.checkpoint_watch_path,
            "checkpoint_stall_seconds": attempt.checkpoint_stall_seconds,
            "evaluation_contract_ref": attempt.evaluation_contract_ref,
            "evaluation_contract_sha256": attempt.evaluation_contract_sha256,
            "protected_artifact_report_ref": attempt.protected_artifact_report_ref,
