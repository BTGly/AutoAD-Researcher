...
def _append_conversation_route_decided_event(
    ...
    *,
    ...
    append_typed_event(run_dir, "planner.conversation_route.decided", {
        ...
        "conversation_intents": decision.conversation_intents,
        "contract_mutation_requested": decision.contract_mutation_request.requested,
        "confirmation_requested": decision.confirmation_request.requested,
        "confirmation_request_action": decision.confirmation_request.action,
