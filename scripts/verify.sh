...
test -f src/autoad_researcher/assets/builder.py
...
test -f src/autoad_researcher/environments/validation.py
test -f src/autoad_researcher/environments/revision.py
