  ...
  return (
    <div className="plus-menu">
      <IconButton
        ...
        label="上传文件"
        aria-expanded={open}
        aria-controls="plus-menu-popover"
      ><Plus size={18} aria-hidden="true" /></IconButton>
      {present && (
        <>
          <div className="plus-menu-scrim" aria-hidden="true" onClick={() => setOpen(false)} />
          <div id="plus-menu-popover" className="plus-menu-popover" data-state={state} aria-hidden={!open}>
