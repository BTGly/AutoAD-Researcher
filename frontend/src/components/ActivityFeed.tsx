...
export function ActivityFeed({ activity, truncated, limit, selectedId, onSelect }: Props) {
  if (activity.length === 0) return <div style={{ color: 'var(--text-muted)', padding: 12 }}>暂无实验动态</div>;
