...
export const sessionStatusLabel = (value: string) => label(value, {
...
export const baselineStatusLabel = (value: string) => label(value, { not_started: '未开始', queued: '已排队', running: '运行中', completed: '已完成', failed: '失败' });
